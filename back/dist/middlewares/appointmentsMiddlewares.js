...
var serviceAppointment = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var service;
    return __generator(this, function (_a) {
        service = req.body.service;
        try {
            if (service === "Compra de vehículo" || service === "Prueba de manejo" ||
                service === "Asesoramiento personalizado" || service === "Servicio de mantenimiento")
                next();
            else
